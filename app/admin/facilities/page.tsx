    ...
    <AdminShell>
      ...
      <div className="grid gap-8 lg:grid-cols-[320px_1fr]">
        ...
        >
          ...
          <div className="rounded-3xl border border-black/5 bg-[#f6faf7] p-6">
            ...
            <div className="mt-6 space-y-4">
              ...
              <input
                ...
                onChange={(e)=>updateField(
                  activeLanguage==="en" ? "titleEn" : "titleId",
                  e.target.value
                )}
                placeholder="Title"
              ...
              <input
                value={activeLanguage==="en" ? form.eyebrowEn : form.eyebrowId}
                onChange={(e)=>updateField(
                  activeLanguage==="en" ? "eyebrowEn" : "eyebrowId",
                  e.target.value
                )}
                placeholder="Eyebrow"
                className="w-full rounded-xl border p-3"
              ...
              <textarea
                value={activeLanguage==="en" ? form.summaryEn : form.summaryId}
                onChange={(e)=>updateField(
                  activeLanguage==="en" ? "summaryEn" : "summaryId",
                  e.target.value
                )}
                placeholder="Summary"
              ...
              <textarea
                value={activeLanguage==="en" ? form.contentEn : form.contentId}
                onChange={(e)=>updateField(
                  activeLanguage==="en" ? "contentEn" : "contentId",
                  e.target.value
                )}
                placeholder="Content"
              ...
              <textarea
                value={activeLanguage==="en" ? form.pointsEn : form.pointsId}
                onChange={(e)=>updateField(
                  activeLanguage==="en" ? "pointsEn" : "pointsId",
                  e.target.value
                )}
          ...
          <div className="rounded-3xl border border-black/5 p-6">
            ...
            <p className="mb-4 text-xs font-black uppercase tracking-[0.16em] text-[#039147]">
              Cover Image
            </p>
            ...
            {form.image ? (
              <button
                ...
                className="mt-4 rounded-full bg-red-100 px-5 py-2 text-sm font-black text-red-600"
              >
                Remove Image
              </button>
            ) : null}
